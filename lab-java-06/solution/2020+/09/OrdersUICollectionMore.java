import java.util.*; // Scanner, Set, TreeSet, Collections...
    ...
    public void calculatePrice(){
        ...
        for(String key: listNames ){
            ...
            if ( listTotal>0.0 ){
                ...
                TransactionFeeComparator tfc = new TransactionFeeComparator();
                tfc.setAmount(listTotal);
                Collections.sort(availPMs, tfc );
