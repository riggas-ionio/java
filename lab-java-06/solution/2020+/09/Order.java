...
public class Order implements Comparable<Order>{
    ...
    public int compareTo(Order other){
        ...
        // 25.00 - 25.005 = abs(-0.005)<0.01 => equal ie return 0
        // 25.005 - 25.00 = abs(0.005)<0.01 => equal ie return 0
        // 25.10 - 25.03 = 0.07 => this is greater ie return 1
        // 25.00 - 25.03 = -0.03 => other is greater ie return -1
        if ( Math.abs(priceDiff) < 0.01 ) // avoiding double comparison
            return 0;
